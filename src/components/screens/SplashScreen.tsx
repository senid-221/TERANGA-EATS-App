...
export const SplashScreen: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-end"><span className="text-xs font-bold px-3.5 py-1.5 bg-white/10 backdrop-blur-md rounded-full border border-white/20">TerangaEats</span></div>
      <div className="flex flex-col items-center text-center">
        <motion.div initial={{scale:.5,opacity:0,rotate:-15}} animate={{scale:1,opacity:1,rotate:0}} transition={{type:'spring',stiffness:260,damping:20}} className="relative mb-6">
          <div className="w-28 h-28 rounded-[32px] bg-gradient-to-tr from-[#FFCC00] to-[#E8702A] p-1 shadow-[0_16px_36px_rgba(0,0,0,0.4)] flex items-center justify-center"><div className="w-full h-full bg-[#006633] rounded-[28px] flex flex-col items-center justify-center p-3 text-center border border-white/30"><Utensils className="w-8 h-8 text-[#FFCC00] mb-1" /><span className="text-[10px] font-black tracking-widest text-[#FFCC00] uppercase">Teranga</span></div></div>
        ...
        <motion.h1 initial={{y:20,opacity:0}} animate={{y:0,opacity:1}} transition={{delay:.3}} className="font-heading text-4xl sm:text-5xl font-black tracking-tight text-white mb-2">Teranga<span className="text-[#FFCC00]">Eats</span></motion.h1>
